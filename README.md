...
- **[ppt-to-beamer-skill](https://github.com/wenlzhang/ppt-to-beamer-skill)** — the generalised Claude Skill *distilled from* this template's development process. Apply it to any institution's PowerPoint master to build a similar Beamer theme.
